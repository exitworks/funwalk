  ...
  <div class="contents"> 
    ...
    <main>
      <div id="app"> 
        ...
        <li>
            <div class="charaBox"><img src="/wp-content/themes/fpw/assets/img/app/app_chara35.png"></div>
            <div class="txtBox">
              <h4>島耕作</h4>
              <p>学生からやがては社長、会長になるまでの出世街道を描く国民的漫画『島耕作』シリーズの主人公。</p>
              <p class="credit">(C)弘兼憲史 / 講談社</p>
            </div>
          </li>
