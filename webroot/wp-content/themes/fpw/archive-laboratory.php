...
if($category != '') {
	$term_id = get_term_by('slug', $category, 'taxonomy_slug_laboratory')->term_id;
	if (!$term_id) {
...
<div class="container">
    <div class="breadcrumb"><a href="/">FUN+WALK PROJECTトップ</a>　&gt;　あるく研究所</div>
    <div class="contents">
        ...
        <main role="main">
            ...
            <div class="mainImg2nd"><img src="<?php bloginfo('template_url'); ?>/assets/img/main_laboratory.png"></div>
            ...
            <?php
                ...
                // カテゴリを検索条件に追加
                if($category != '' && $term_id){
                    $args['meta_key'] = 'rdo_taxonomy_laboratory';
                ...
                <article class="postNew">
                    ...
                    <div class="postTxtbox">
                        <?php if($category->name != ""){?>
                           <div class="icon-laboratory"><a href="/laboratory/category/<?php echo esc_html($category->slug)?>/"><?php echo esc_html($category->name) ?></a></div>
						<?php }?>
