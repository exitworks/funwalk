...
<div class="container">
	<div class="breadcrumb"><a href="/">FUN+WALK PROJECTトップ</a>　&gt;　<a href="/<?php echo esc_html($post_type);?>/">FUN+WALKコラム</a>　&gt;　<?php the_title(); ?></div>
	<div class="contents">
		...
		<main>
			...
			<div class="post">
				...
				<div class="btnArea">
					<div class="buttonA"><a href="/<?php echo esc_html($post_type);?>/">コラム一覧に戻る</a></div>
				</div>
			</div>
